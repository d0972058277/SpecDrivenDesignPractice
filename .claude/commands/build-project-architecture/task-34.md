# build-project-architecture - Task 34

Execute task 34 for the build-project-architecture specification.

## Task Description
Create sample Controller in WebAPI

## Code Reuse
**Leverage existing code**: reference/DDD4rchitectureDotNet/src/Project.WebApi/Controllers/SomethingController.cs
...
## Usage
```
/Task:34-build-project-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create sample Controller in WebAPI"

```
Use the @spec-task-executor agent to implement task 34: "Create sample Controller in WebAPI" for the build-project-architecture specification and include all the below context.
...
## Task Details
- Task ID: 34
- Description: Create sample Controller in WebAPI
- Leverage: reference/DDD4rchitectureDotNet/src/Project.WebApi/Controllers/SomethingController.cs
- Requirements: 3.1

## Instructions
- Implement ONLY task 34: "Create sample Controller in WebAPI"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks build-project-architecture 34 --mode complete
...
```bash
claude-code-spec-workflow get-tasks build-project-architecture 34 --mode complete
```
