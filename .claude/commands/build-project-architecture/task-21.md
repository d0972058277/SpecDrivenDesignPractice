# build-project-architecture - Task 21

Execute task 21 for the build-project-architecture specification.

## Task Description
Create sample Command in Application

## Code Reuse
**Leverage existing code**: reference/DDD4rchitectureDotNet/src/Project.Application/UseCases/Commands/CreateAggregateCommand.cs
...
## Usage
```
/Task:21-build-project-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create sample Command in Application"

```
Use the @spec-task-executor agent to implement task 21: "Create sample Command in Application" for the build-project-architecture specification and include all the below context.
...
## Task Details
- Task ID: 21
- Description: Create sample Command in Application
- Leverage: reference/DDD4rchitectureDotNet/src/Project.Application/UseCases/Commands/CreateAggregateCommand.cs
- Requirements: 3.1, 3.3

## Instructions
- Implement ONLY task 21: "Create sample Command in Application"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks build-project-architecture 21 --mode complete
...
```bash
claude-code-spec-workflow get-tasks build-project-architecture 21 --mode complete
```
