# build-project-architecture - Task 36

Execute task 36 for the build-project-architecture specification.

## Task Description
Create Request/Response models in WebAPI

## Code Reuse
**Leverage existing code**: reference/DDD4rchitectureDotNet/src/Project.WebApi/Models/CreateAggregateRequest.cs
...
## Usage
```
/Task:36-build-project-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create Request/Response models in WebAPI"

```
Use the @spec-task-executor agent to implement task 36: "Create Request/Response models in WebAPI" for the build-project-architecture specification and include all the below context.
...
## Task Details
- Task ID: 36
- Description: Create Request/Response models in WebAPI
- Leverage: reference/DDD4rchitectureDotNet/src/Project.WebApi/Models/CreateAggregateRequest.cs
- Requirements: 3.1

## Instructions
- Implement ONLY task 36: "Create Request/Response models in WebAPI"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks build-project-architecture 36 --mode complete
...
```bash
claude-code-spec-workflow get-tasks build-project-architecture 36 --mode complete
```
