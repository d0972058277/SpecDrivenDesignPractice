# build-project-architecture - Task 3

Execute task 3 for the build-project-architecture specification.

## Task Description
Implement IAggregateRoot interface in Core.Architecture

## Code Reuse
**Leverage existing code**: reference/DDD4rchitectureDotNet/src/Architecture/Core/IAggregateRoot.cs
...
## Usage
```
/Task:3-build-project-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement IAggregateRoot interface in Core.Architecture"

```
Use the @spec-task-executor agent to implement task 3: "Implement IAggregateRoot interface in Core.Architecture" for the build-project-architecture specification and include all the below context.
...
## Task Details
- Task ID: 3
- Description: Implement IAggregateRoot interface in Core.Architecture
- Leverage: reference/DDD4rchitectureDotNet/src/Architecture/Core/IAggregateRoot.cs
- Requirements: 2.1, 2.3

## Instructions
- Implement ONLY task 3: "Implement IAggregateRoot interface in Core.Architecture"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks build-project-architecture 3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks build-project-architecture 3 --mode complete
```
