# build-project-architecture - Task 18

Execute task 18 for the build-project-architecture specification.

## Task Description
Create sample Aggregate Root in Domain

## Code Reuse
**Leverage existing code**: reference/DDD4rchitectureDotNet/src/Project.Domain/Aggregates/Something/SomethingAggregate.cs
...
## Usage
```
/Task:18-build-project-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create sample Aggregate Root in Domain"

```
Use the @spec-task-executor agent to implement task 18: "Create sample Aggregate Root in Domain" for the build-project-architecture specification and include all the below context.
...
## Task Details
- Task ID: 18
- Description: Create sample Aggregate Root in Domain
- Leverage: reference/DDD4rchitectureDotNet/src/Project.Domain/Aggregates/Something/SomethingAggregate.cs
- Requirements: 2.1, 2.3, 4.1

## Instructions
- Implement ONLY task 18: "Create sample Aggregate Root in Domain"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks build-project-architecture 18 --mode complete
...
```bash
claude-code-spec-workflow get-tasks build-project-architecture 18 --mode complete
```
