# build-project-architecture - Task 24

Execute task 24 for the build-project-architecture specification.

## Task Description
Create sample Command Handler in Application

## Code Reuse
**Leverage existing code**: reference/DDD4rchitectureDotNet/src/Project.Application/UseCases/Commands/CreateAggregateCommandHandler.cs
...
## Usage
```
/Task:24-build-project-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create sample Command Handler in Application"

```
Use the @spec-task-executor agent to implement task 24: "Create sample Command Handler in Application" for the build-project-architecture specification and include all the below context.
...
## Task Details
- Task ID: 24
- Description: Create sample Command Handler in Application
- Leverage: reference/DDD4rchitectureDotNet/src/Project.Application/UseCases/Commands/CreateAggregateCommandHandler.cs
- Requirements: 3.1, 3.3, 5.3

## Instructions
- Implement ONLY task 24: "Create sample Command Handler in Application"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks build-project-architecture 24 --mode complete
...
```bash
claude-code-spec-workflow get-tasks build-project-architecture 24 --mode complete
```
