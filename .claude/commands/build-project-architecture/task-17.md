# build-project-architecture - Task 17

Execute task 17 for the build-project-architecture specification.

## Task Description
Create sample Domain Event in Domain

## Code Reuse
**Leverage existing code**: reference/DDD4rchitectureDotNet/src/Project.Domain/Events/AggregateCreatedDomainEvent.cs
...
## Usage
```
/Task:17-build-project-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create sample Domain Event in Domain"

```
Use the @spec-task-executor agent to implement task 17: "Create sample Domain Event in Domain" for the build-project-architecture specification and include all the below context.
...
## Task Details
- Task ID: 17
- Description: Create sample Domain Event in Domain
- Leverage: reference/DDD4rchitectureDotNet/src/Project.Domain/Events/AggregateCreatedDomainEvent.cs
- Requirements: 4.1

## Instructions
- Implement ONLY task 17: "Create sample Domain Event in Domain"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks build-project-architecture 17 --mode complete
...
```bash
claude-code-spec-workflow get-tasks build-project-architecture 17 --mode complete
```
