# build-project-architecture - Task 23

Execute task 23 for the build-project-architecture specification.

## Task Description
Create Repository interface in Application

## Code Reuse
**Leverage existing code**: reference/DDD4rchitectureDotNet/src/Project.Application/Interfaces/ISomethingRepository.cs
...
## Usage
```
/Task:23-build-project-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create Repository interface in Application"

```
Use the @spec-task-executor agent to implement task 23: "Create Repository interface in Application" for the build-project-architecture specification and include all the below context.
...
## Task Details
- Task ID: 23
- Description: Create Repository interface in Application
- Leverage: reference/DDD4rchitectureDotNet/src/Project.Application/Interfaces/ISomethingRepository.cs
- Requirements: 6.1

## Instructions
- Implement ONLY task 23: "Create Repository interface in Application"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks build-project-architecture 23 --mode complete
...
```bash
claude-code-spec-workflow get-tasks build-project-architecture 23 --mode complete
```
