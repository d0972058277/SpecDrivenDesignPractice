# build-project-architecture - Task 28

Execute task 28 for the build-project-architecture specification.

## Task Description
Create Database Context in Infrastructure

## Code Reuse
**Leverage existing code**: reference/DDD4rchitectureDotNet/src/Project.Infrastructure/Persistence/ApplicationDbContext.cs
...
## Usage
```
/Task:28-build-project-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create Database Context in Infrastructure"

```
Use the @spec-task-executor agent to implement task 28: "Create Database Context in Infrastructure" for the build-project-architecture specification and include all the below context.
...
## Task Details
- Task ID: 28
- Description: Create Database Context in Infrastructure
- Leverage: reference/DDD4rchitectureDotNet/src/Project.Infrastructure/Persistence/ApplicationDbContext.cs
- Requirements: 6.3, 4.1

## Instructions
- Implement ONLY task 28: "Create Database Context in Infrastructure"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks build-project-architecture 28 --mode complete
...
```bash
claude-code-spec-workflow get-tasks build-project-architecture 28 --mode complete
```
