# build-project-architecture - Task 15

Execute task 15 for the build-project-architecture specification.

## Task Description
Create sample ValueObject with validation in Domain

## Code Reuse
**Leverage existing code**: reference/DDD4rchitectureDotNet/src/Project.Domain/ValueObjects/SomethingValueObject.cs
...
## Usage
```
/Task:15-build-project-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create sample ValueObject with validation in Domain"

```
Use the @spec-task-executor agent to implement task 15: "Create sample ValueObject with validation in Domain" for the build-project-architecture specification and include all the below context.
...
## Task Details
- Task ID: 15
- Description: Create sample ValueObject with validation in Domain
- Leverage: reference/DDD4rchitectureDotNet/src/Project.Domain/ValueObjects/SomethingValueObject.cs
- Requirements: 2.5, 5.1

## Instructions
- Implement ONLY task 15: "Create sample ValueObject with validation in Domain"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks build-project-architecture 15 --mode complete
...
```bash
claude-code-spec-workflow get-tasks build-project-architecture 15 --mode complete
```
