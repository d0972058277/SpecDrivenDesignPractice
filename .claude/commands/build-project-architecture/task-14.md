# build-project-architecture - Task 14

Execute task 14 for the build-project-architecture specification.

## Task Description
Create sample strong-typed ID in Domain

## Code Reuse
**Leverage existing code**: reference/DDD4rchitectureDotNet/src/Project.Domain/Aggregates/Something/SomethingId.cs
...
## Usage
```
/Task:14-build-project-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create sample strong-typed ID in Domain"

```
Use the @spec-task-executor agent to implement task 14: "Create sample strong-typed ID in Domain" for the build-project-architecture specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: Create sample strong-typed ID in Domain
- Leverage: reference/DDD4rchitectureDotNet/src/Project.Domain/Aggregates/Something/SomethingId.cs
- Requirements: 2.2

## Instructions
- Implement ONLY task 14: "Create sample strong-typed ID in Domain"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks build-project-architecture 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks build-project-architecture 14 --mode complete
```
