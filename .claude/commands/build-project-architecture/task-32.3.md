# build-project-architecture - Task 32.3

Execute task 32.3 for the build-project-architecture specification.

## Task Description
Create IdGenerator utility in Core.Architecture

## Code Reuse
**Leverage existing code**: reference/DDD4rchitectureDotNet/src/Architecture/Shell/IdGenerator.cs
...
## Usage
```
/Task:32.3-build-project-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create IdGenerator utility in Core.Architecture"

```
Use the @spec-task-executor agent to implement task 32.3: "Create IdGenerator utility in Core.Architecture" for the build-project-architecture specification and include all the below context.
...
## Task Details
- Task ID: 32.3
- Description: Create IdGenerator utility in Core.Architecture
- Leverage: reference/DDD4rchitectureDotNet/src/Architecture/Shell/IdGenerator.cs
- Requirements: 2.2

## Instructions
- Implement ONLY task 32.3: "Create IdGenerator utility in Core.Architecture"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks build-project-architecture 32.3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks build-project-architecture 32.3 --mode complete
```
