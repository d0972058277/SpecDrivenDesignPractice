# build-project-architecture - Task 25

Execute task 25 for the build-project-architecture specification.

## Task Description
Create sample Query Handler in Application

## Code Reuse
**Leverage existing code**: reference/DDD4rchitectureDotNet/src/Project.Application/UseCases/Queries/GetSomethingQueryHandler.cs
...
## Usage
```
/Task:25-build-project-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create sample Query Handler in Application"

```
Use the @spec-task-executor agent to implement task 25: "Create sample Query Handler in Application" for the build-project-architecture specification and include all the below context.
...
## Task Details
- Task ID: 25
- Description: Create sample Query Handler in Application
- Leverage: reference/DDD4rchitectureDotNet/src/Project.Application/UseCases/Queries/GetSomethingQueryHandler.cs
- Requirements: 3.1, 3.4, 5.3

## Instructions
- Implement ONLY task 25: "Create sample Query Handler in Application"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks build-project-architecture 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks build-project-architecture 25 --mode complete
```
