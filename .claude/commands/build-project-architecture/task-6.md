# build-project-architecture - Task 6

Execute task 6 for the build-project-architecture specification.

## Task Description
Create AggregateRoot base class in Core.Architecture

## Code Reuse
**Leverage existing code**: reference/DDD4rchitectureDotNet/src/Architecture/Core/AggregateRoot.cs
...
## Usage
```
/Task:6-build-project-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create AggregateRoot base class in Core.Architecture"

```
Use the @spec-task-executor agent to implement task 6: "Create AggregateRoot base class in Core.Architecture" for the build-project-architecture specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: Create AggregateRoot base class in Core.Architecture
- Leverage: reference/DDD4rchitectureDotNet/src/Architecture/Core/AggregateRoot.cs
- Requirements: 2.1, 2.3

## Instructions
- Implement ONLY task 6: "Create AggregateRoot base class in Core.Architecture"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks build-project-architecture 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks build-project-architecture 6 --mode complete
```
