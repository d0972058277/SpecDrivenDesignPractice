# build-project-architecture - Task 26

Execute task 26 for the build-project-architecture specification.

## Task Description
Create sample DTO in Application

## Code Reuse
**Leverage existing code**: reference/DDD4rchitectureDotNet/src/Project.Application/DTOs/SomethingDto.cs
...
## Usage
```
/Task:26-build-project-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create sample DTO in Application"

```
Use the @spec-task-executor agent to implement task 26: "Create sample DTO in Application" for the build-project-architecture specification and include all the below context.
...
## Task Details
- Task ID: 26
- Description: Create sample DTO in Application
- Leverage: reference/DDD4rchitectureDotNet/src/Project.Application/DTOs/SomethingDto.cs
- Requirements: 3.4

## Instructions
- Implement ONLY task 26: "Create sample DTO in Application"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks build-project-architecture 26 --mode complete
...
```bash
claude-code-spec-workflow get-tasks build-project-architecture 26 --mode complete
```
