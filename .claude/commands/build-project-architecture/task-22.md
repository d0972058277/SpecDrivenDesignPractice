# build-project-architecture - Task 22

Execute task 22 for the build-project-architecture specification.

## Task Description
Create sample Query in Application

## Code Reuse
**Leverage existing code**: reference/DDD4rchitectureDotNet/src/Project.Application/UseCases/Queries/GetSomethingQuery.cs
...
## Usage
```
/Task:22-build-project-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create sample Query in Application"

```
Use the @spec-task-executor agent to implement task 22: "Create sample Query in Application" for the build-project-architecture specification and include all the below context.
...
## Task Details
- Task ID: 22
- Description: Create sample Query in Application
- Leverage: reference/DDD4rchitectureDotNet/src/Project.Application/UseCases/Queries/GetSomethingQuery.cs
- Requirements: 3.1, 3.4

## Instructions
- Implement ONLY task 22: "Create sample Query in Application"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks build-project-architecture 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks build-project-architecture 22 --mode complete
```
