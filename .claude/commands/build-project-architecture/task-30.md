# build-project-architecture - Task 30

Execute task 30 for the build-project-architecture specification.

## Task Description
Create Unit of Work implementation in Infrastructure

## Code Reuse
**Leverage existing code**: reference/DDD4rchitectureDotNet/src/Project.Infrastructure/UnitOfWork.cs

## Requirements Reference
**Requirements**: 6.2, 4.1

## Usage
```
/Task:30-build-project-architecture
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create Unit of Work implementation in Infrastructure"

```
Use the @spec-task-executor agent to implement task 30: "Create Unit of Work implementation in Infrastructure" for the build-project-architecture specification and include all the below context.
...
## Task Details
- Task ID: 30
- Description: Create Unit of Work implementation in Infrastructure
- Leverage: reference/DDD4rchitectureDotNet/src/Project.Infrastructure/UnitOfWork.cs
- Requirements: 6.2, 4.1

## Instructions
- Implement ONLY task 30: "Create Unit of Work implementation in Infrastructure"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks build-project-architecture 30 --mode complete
...
```bash
claude-code-spec-workflow get-tasks build-project-architecture 30 --mode complete
```
